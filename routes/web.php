...
Route::get('/produtos/{prod}', [ProdutosController::class, 'show'])->name('produtos.mostrar');
...
Route::get('/profile', [UsuariosController::class, 'show'])->middleware(['verified'])->name('profile.mostrar');
...
Route::get('/recados/{recado}', [RecadosController::class, 'show'])->name('recados.mostrar');
...
Route::post('/produtos/imagens', [ProdutosController::class, 'images'])->name('image.criar'); 
Route::post('/produtos/imagens', [ProdutosController::class, 'images'])->name('image.criar');

Route::get('blog', [BlogController::class, 'index'])->name('blog');

Route::get('/blog/inserir', [BlogController::class, 'criar'])->name('blog.inserir');

Route::post('/blog/inserir', [BlogController::class, 'loja'])->name('blog.gravar');

Route::get('/blog/{post}', [BlogController::class, 'mostrar'])->name('blog.show'); 
